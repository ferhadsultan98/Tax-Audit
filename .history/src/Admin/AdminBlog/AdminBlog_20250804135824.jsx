...
const AdminBlog = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    excerpt_en: "",
    excerpt_ru: "",
    content_az: [{ type: "paragraph", children: [{ text: "" }] }],
    content_en: [{ type: "paragraph", children: [{ text: "" }] }],
    content_ru: [{ type: "paragraph", children: [{ text: "" }] }],
    category: "audit",
    author: "",
    image: null,
    featured: false,
  ...
  const handleSlateChange = (value, field) => {
    setFormData((prev) => ({
      ...prev,
      [field]: value,
    }));
  ...
  const handleSubmit = async (e) => {
    ...
    data.append("content_az", JSON.stringify(formData.content_az));
    data.append("content_en", JSON.stringify(formData.content_en));
    data.append("content_ru", JSON.stringify(formData.content_ru));
  ...
  const handleEdit = (post) => {
    ...
    setFormData({
      ...
      content_az: post.content_az
        ? JSON.parse(post.content_az)
        : [{ type: "paragraph", children: [{ text: "" }] }],
      content_en: post.content_en
        ? JSON.parse(post.content_en)
        : [{ type: "paragraph", children: [{ text: "" }] }],
      content_ru: post.content_ru
        ? JSON.parse(post.content_ru)
        : [{ type: "paragraph", children: [{ text: "" }] }],
      ...
      <div className="createBlogForm">
        ...
        <div className="formGroup fullWidth">
          ...
          <Slate
            ...
            onChange={(value) => handleSlateChange(value, `content_${language}`)}
          >
            <Editable
