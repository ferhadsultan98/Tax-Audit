...
const AdminBlog = () => {
  ...
  useEffect(() => {
    axios
      .get("https://primetradegroup.az/api/blog/posts/")
      .then((res) => {
    ...
    try {
      if (editingId) {
        const res = await axios.put(
          `https://primetradegroup.az/api/blog/posts/${editingId}/`,
          data,
        ...
        const res = await axios.post(
          "https://primetradegroup.az/api/blog/posts/",
          data,
          { headers: { "Content-Type": "multipart/form-data" } }
        );
  ...
  const handleDelete = async (id) => {
    if (window.confirm("Bu yazını silmək istədiyinizə əminsiniz?")) {
      try {
        await axios.delete(`https://primetradegroup.az/api/blog/posts/${id}/`);
          ...
          currentPosts.map((post) => (
            <div key={post.id} className="blogCard">
              <div className="cardImage">
                {post.image_id ? (
                  <img
                    src={`https://primetradegroup.az/api/blog/images/${post.image_id}/`}
                  />
                ) : (
