...
import postsData from "../../data/BlogPosts.json"; // Import JSON data
import "./Blog.scss";
              ...
              {featuredPost && (
                ...
                >
                    ...
                    <img
                      src={
                        featuredPost.image_id
                          ? `/images/${featuredPost.image_id}.jpg` // Adjust path for your setup
                          : ""
                      }
                  ...
                  <div className="featuredContent">
                    ...
                    <h2>
                      {truncateText(
                        featuredPost[`title_${language}`] || featuredPost.title_en,
                        isWideLayout ? 50 : 80
                      )}
                    </h2>
                    <p className="excerpt">
                      {truncateText(
                        featuredPost[`excerpt_${language}`] || featuredPost.excerpt_en,
