              ...
              {featuredPost && (
                ...
                >
                  <div className="featuredImage">
                    <img src={featuredPost.image} alt={featuredPost[`title_${language}`] || ""} />
                  ...
                  <div className="featuredContent">
                    ...
                    <p className="excerpt">{featuredPost[`excerpt_${language}`] || ""}</p>
                ...
                {regularPosts.map((post) => (
                  <article key={post.id} className="postCard">
                    <div className="postImage">
                      <img src={post.image_id} alt={post[`title_${language}`] || ""} />
                      {post.trending && (
                        <span className="trendingBadge">
                          <TrendingUp size={12} />
                          Trending
                    ...
                    <div className="postContent">
                      ...
                      <p className="excerpt">{post[`excerpt_${language}`] || ""}</p>
