  ...
  const faqData = {
    ...
    audit: [
      ...
      },
      {
        ...
        answer: "The duration of an audit depends on several factors including the size of the organization, complexity of operations, quality of records, and scope of the audit. A typical financial statement audit for a medium-sized company takes 2-4 weeks. We provide a detailed timeline during the planning phase."
      }
    ],
    tax: [
      {
    ...
    accounting: [
      {
        ...
        answer: "Our accounting services include complete organization and maintenance of financial and tax accounting records, preparation and submission of all required declarations and reports, implementation of accounting systems, monthly/quarterly financial reporting, and ongoing bookkeeping support."
      },
      {
        id: 21,
        question: "Can you help set up our accounting system?",
        answer: "Yes, we provide comprehensive accounting system implementation including software selection based on your needs, chart of accounts design, workflow and process development, staff training, and ongoing support. We work with various accounting software platforms."
      },
      {
        id: 22,
        question: "Do you offer outsourced accounting services?",
        answer: "Yes, we offer complete outsourced accounting solutions where we handle all your accounting needs remotely. This includes daily bookkeeping, financial reporting, tax compliance, payroll processing, and management reporting. This allows you to focus on your core business activities."
      },
      {
        id: 23,
        question: "How do you ensure data security?",
        answer: "We take data security very seriously. Our measures include encrypted data transmission, secure cloud storage, restricted access controls, regular backups, confidentiality agreements, and compliance with data protection regulations. Your financial information is always protected."
      }
    ],
    pricing: [
      {
        ...
        answer: "Our pricing is based on several factors including scope of services, complexity of work, time requirements, and expertise needed. We offer both fixed-fee and hourly billing options. After understanding your needs, we provide a detailed proposal with transparent pricing."
      },
      {
        id: 25,
        question: "Do you offer package deals?",
        answer: "Yes, we offer bundled service packages that provide cost savings for clients who need multiple services. Common packages include audit + tax compliance, full outsourced accounting + tax, and comprehensive business advisory packages. These are customized based on your needs."
      },
      {
        id: 26,
        question: "What payment terms do you offer?",
        answer: "We offer flexible payment terms to accommodate different client needs. Options include monthly retainers for ongoing services, progress billing for project-based work, and annual contracts with quarterly payments. We work with you to find suitable payment arrangements."
      }
    ]
  };
          ...
          <div className="faqGrid">
            <div className="faqList">
              {filteredFAQs().length > 0 ? (
                filteredFAQs().map((faq) => (
                  <div 
                    key={faq.id} 
                    className={`faqItem ${activeAccordions[`${activeCategory}-${faq.id}`] ? 'active' : ''}`}
                  >
                    <button 
            ...
            <aside className="faqSidebar">
              ...
              <div className="helpCard">
                ...
                <p>Can't find the answer you're looking for? Our expert team is here to help.</p>
